...
CREATE TABLE silver.crm_prd_info (
    prd_id          INT,
    cat_id          	NVARCHAR(50), -- this column is added to split the original column into 2 columns to be a key for another table
    prd_key         	NVARCHAR(50), -- this column is added to split the original column into 2 columns to be a key for another table
    prd_nm          	NVARCHAR(50),
    prd_cost        	INT,
